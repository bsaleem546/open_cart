        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('attributes.create') }}" class="btn btn-outline-primary">Add New</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="example" class="display" style="min-width: 845px">
                        ...
                        @foreach($data as $attributes)
                            <tr>
                                ...
                                <td><a href="{{ route('attributes.edit', $attributes->id) }}"><i class="fas fa-cog"></i></a>
                                     |
                                    <a href="#" onclick="_delete( {{ $attributes }} )"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
    ...
    <script>
        ...
        function _delete(data) {
            ...
            document.getElementById('delete').addEventListener('click', (e) => {
                $.ajax({
                    type: 'DELETE',
                    url: main_url+'admin/attributes/'+data.id,
                    contentType: false,
                    processData: false,
