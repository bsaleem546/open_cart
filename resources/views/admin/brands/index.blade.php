        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-toolbar">
                    <a href="{{ route('brands.create') }}" class="btn btn-outline-primary">Add New</a>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <table id="example" class="display" style="min-width: 845px">
                        ...
                        @foreach($data as $brands)
                            <tr>
                                ...
                                <td><a href="{{ route('brands.edit', $brands->id) }}"><i class="fas fa-cog"></i></a>
                                     |
                                    <a href="#" onclick="_delete( {{ $brands }} )"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </table>
    ...
    <script>
        ...
        function _delete(data) {
            ...
            document.getElementById('delete').addEventListener('click', (e) => {
                $.ajax({
                    type: 'DELETE',
                    url: main_url+'admin/brands/'+data.id,
                    contentType: false,
                    processData: false,
